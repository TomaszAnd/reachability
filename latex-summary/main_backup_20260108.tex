...
\end{itemize}
The total operator count is $|\mathcal{P}_2| = L = 3n + 9|E|$. Following ~\cite{quek2025quantumadvantagerandomgeometricallytwolocal} we will consider rectangular 2D lattice with $n = L_x \times L_y$ sites with nearest-neighbor connectivity, for which $|E| = 2L_x L_y - L_x - L_y$. \ko{Note that in the single excitation subspace, the geometric 2-local interactions reduce to the qudit Hamiltonians \cite{wang_symmetry_2012,schirmer_design_2018}.}
