...
- Branch: `fast` (optimized from `clean`)
...
| `notebooks/quickstart.ipynb` | Interactive demo (~5-8 min) |
...
```bash
python scripts/tests/run_all_tests.py         # Full (34 tests)
python scripts/tests/run_all_tests.py --quick  # Quick (~1s)
```
...
└── tests/
    ├── run_all_tests.py            # 34 tests in 8 groups (A-H)
